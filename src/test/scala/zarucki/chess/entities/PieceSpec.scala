...
class PieceSpec extends UnitSpec {
	...
	it should "properly move in all directions all the squares" in {
		val queenValidMoves = Queen.possibleMoveDestinationsFromPlace(BoardAddress(File("C"), 2), maxFile = File("E"), maxRank = 4)
	...
	it should "correctly handle being in the corner" in {
		val queenValidMoves = Queen.possibleMoveDestinationsFromPlace(BoardAddress(File("A"), 0), maxFile = File("C"), maxRank = 2)
		assert(queenValidMoves.toSet == Set(
	...
	it should "correctly handle 2 x 1 chess board" in {
		val queenValidMoves = Queen.possibleMoveDestinationsFromPlace(BoardAddress(File("B"), 0), maxFile = File("B"), maxRank = 0)
		assert(queenValidMoves.toSet == Set(BoardAddress(File("A"), 0)))
	}

	it should "correctly handle 1 x 1 chess board" in {
		val queenValidMoves = Queen.possibleMoveDestinationsFromPlace(BoardAddress(File("A"), 0), maxFile = File("A"), maxRank = 0)
	...
	it should "properly move in all directions one square" in {
		val kingValidMoves = King.possibleMoveDestinationsFromPlace(BoardAddress(File("C"), 2), maxFile = File("E"), maxRank = 4)
	...
	it should "correctly handle being in the corner SW" in {
		val kingValidMoves = King.possibleMoveDestinationsFromPlace(BoardAddress(File("A"), 0), maxFile = File("C"), maxRank = 2)
	...
	it should "correctly handle being in the corner SE" in {
		val kingValidMoves = King.possibleMoveDestinationsFromPlace(BoardAddress(File("C"), 0), maxFile = File("C"), maxRank = 2)
		assert(kingValidMoves.toSet == Set(BoardAddress(File("C"), 1), BoardAddress(File("B"), 0), BoardAddress(File("B"), 1)))
	}

	it should "correctly handle 2 x 1 chess board" in {
		val kingValidMoves = King.possibleMoveDestinationsFromPlace(BoardAddress(File("B"), 0), maxFile = File("B"), maxRank = 0)
		assert(kingValidMoves.toSet == Set(BoardAddress(File("A"), 0)))
	}

	it should "correctly handle 1 x 1 chess board" in {
		val kingValidMoves = King.possibleMoveDestinationsFromPlace(BoardAddress(File("A"), 0), maxFile = File("A"), maxRank = 0)
	...
	it should "properly move in NE, SE, SW, NW" in {
		val bishopValidMoves = Bishop.possibleMoveDestinationsFromPlace(BoardAddress(File("C"), 2), maxFile = File("E"), maxRank = 4)
	...
	it should "correctly handle being in the corner" in {
		val bishopValidMoves = Bishop.possibleMoveDestinationsFromPlace(BoardAddress(File("A"), 0), maxFile = File("C"), maxRank = 2)
		assert(bishopValidMoves.toSet == Set(BoardAddress(File("B"), 1), BoardAddress(File("C"), 2)))
	}

	it should "correctly handle 2 x 1 chess board" in {
		val bishopValidMoves = Bishop.possibleMoveDestinationsFromPlace(BoardAddress(File("B"), 0), maxFile = File("B"), maxRank = 0)
	...
	it should "properly move in N, E, S, W" in {
		val rookValidMoves = Rook.possibleMoveDestinationsFromPlace(BoardAddress(File("C"), 2), maxFile = File("E"), maxRank = 4)
	...
	it should "correctly handle being in the corner" in {
		val rookValidMoves = Rook.possibleMoveDestinationsFromPlace(BoardAddress(File("A"), 0), maxFile = File("C"), maxRank = 2)
		assert(rookValidMoves.toSet == Set(
			BoardAddress(File("A"), 1), BoardAddress(File("A"), 2),
			BoardAddress(File("B"), 0), BoardAddress(File("C"), 0))
		)
	...
	it should "correctly handle 2 x 1 chess board" in {
		val rookValidMoves = Rook.possibleMoveDestinationsFromPlace(BoardAddress(File("B"), 0), maxFile = File("B"), maxRank = 0)
		assert(rookValidMoves.toSet == Set(BoardAddress(File("A"), 0)))
	}

	it should "correctly handle 1 x 1 chess board" in {
		val rookValidMoves = Rook.possibleMoveDestinationsFromPlace(BoardAddress(File("A"), 0), maxFile = File("A"), maxRank = 0)
	...
	it should "properly move in horsey way" in {
		val knightValidMoves = Knight.possibleMoveDestinationsFromPlace(BoardAddress(File("C"), 2), maxFile = File("E"), maxRank = 4)
	...
	it should "correctly handle being in the corner" in {
		val knightValidMoves = Knight.possibleMoveDestinationsFromPlace(BoardAddress(File("A"), 0), maxFile = File("C"), maxRank = 2)
		assert(knightValidMoves.toSet == Set(BoardAddress(File("B"), 2), BoardAddress(File("C"), 1)))
	}

	it should "correctly handle 2 x 1 chess board" in {
		val knightValidMoves = Knight.possibleMoveDestinationsFromPlace(BoardAddress(File("B"), 0), maxFile = File("B"), maxRank = 0)
